    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg-page)' }}>
      <div style={{ maxWidth: '640px', margin: '0 auto', padding: '0 20px 80px' }}>
        ...
        <div style={{ background: 'var(--navy)', borderRadius: '0 0 16px 16px', padding: '36px 32px 30px', textAlign: 'center', marginBottom: '36px' }}>
          {!logoBroken ? (
            ...
            <>
              ...
              <h1 style={{ fontSize: '30px', fontWeight: 600, color: 'var(--accent)', margin: 0, fontStyle: 'italic' }}>Exclusive</h1>
        ...
        {orderRef ? (
          ...
          <>
            ...
            <form onSubmit={submit} style={{ ...card, padding: '32px' }}>
              ...
              <div className="ecd-grid2" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '14px', marginBottom: '30px' }}>
        ...
        <div style={{ textAlign: 'center', marginTop: '30px', fontSize: '11px', color: 'var(--text-muted)' }}>
          Design &amp; fulfillment by Kira Custom Jewelry — Exclusive Custom Designs' trusted partner
        </div>
      </div>

      <style>{`@media (max-width: 560px) { .ecd-grid2 { grid-template-columns: 1fr !important; } }`}</style>
    </div>
  );
}
