...
export class ReportsService {
  ...
  // Revision, Still In Progress. The last four are all read off the exact
  ...
  private async computeProductionWindow(from: Date, to: Date, periodType: ProductionPeriodType) {
    ...
    // sitting at Revision Requested, not that a revision was finished.
    // "Still In Progress" is whatever's left of Made once the other three
